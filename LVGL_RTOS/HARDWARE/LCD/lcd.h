 ...
 * F103开发板使用FSMC_NE1连接LCD_CS, FSMC_A18连接LCD_RS ,16位数据线,计算方法如下:
 * 首先FSMC_NE1的基地址为: 0X6000 0000;     NEx的基址为(x=1/2/3/4): 0X6000 0000 + (0X400 0000 * (x - 1))
 * FSMC_A18对应地址值: 2^18 * 2 = 0X80000;    FSMC_Ay对应的地址为(y = 0 ~ 25): 2^y * 2
 *
