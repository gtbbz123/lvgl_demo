...
#define LV_USE_FS_WIN32 0
    ...
    #define LV_FS_WIN32_PATH "D:/code/git/lvgl_demo/lv_port_pc_eclipse-release-v8.2/SDfile"         /*Set the working directory. File/directory paths will be appended to it.*/
